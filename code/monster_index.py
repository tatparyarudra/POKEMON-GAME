...
class MonsterIndex:
	...
	def display_main(self, dt):
		...
		healthbar_rect = pygame.Rect((0,0), (bar_data['width'],bar_data['height'])).move_to(midtop = (bar_data['left_side'], bar_data['top']))
		...
		energybar_rect = pygame.Rect((0,0), (bar_data['width'],bar_data['height'])).move_to(midtop = (bar_data['right_side'], bar_data['top']))
		...
		# stats 
		stats_rect = pygame.Rect(sides['left'], healthbar_rect.bottom, healthbar_rect.width, info_height).inflate(0,-60).move(0,15)
